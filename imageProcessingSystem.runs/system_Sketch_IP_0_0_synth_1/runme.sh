...
HD_PWD='D:/GitCode/SketchSystem/imageProcessingSystem.runs/system_Sketch_IP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Sketch_IP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Sketch_IP_0_0.tcl
