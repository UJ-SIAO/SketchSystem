...
proc create_root_design { parentCell } {
  ...
  # Create instance: Sketch_IP_0, and set properties
  set Sketch_IP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Sketch_IP:1.4.5 Sketch_IP_0 ]
  ...
  connect_bd_intf_net -intf_net Sketch_IP_0_m_axis [get_bd_intf_pins Sketch_IP_0/m_axis] [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins Sketch_IP_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net Sketch_IP_0_o_intr [get_bd_pins Sketch_IP_0/o_intr] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Sketch_IP_0/axi_reset_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
